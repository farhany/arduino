...
// Further tinkered with from http://tronixstuff.com/2013/10/11/

#include <avr/pgmspace.h>
#include <LedControl.h>

#define INTENSITY_HIGHEST 255
#define INTENSITY_MEDIUM  127
#define INTENSITY_LOWEST  0

const int numDevices = 1;      // number of MAX7219s used
const long scrollDelay = 100/2;   // adjust scrolling speed
unsigned long bufferLong [14] = {0}; 

LedControl lc=LedControl(12,11,10,numDevices);

prog_uchar scrollText[] PROGMEM ={ "  ~ ~ Hello FaceBook! ~ ~\0" };
void setup(){
    for (int x=0; x<numDevices; x++){
        lc.shutdown(x,false);       //The MAX72XX is in power-saving mode on startup
        lc.setIntensity(x, INTENSITY_LOWEST);       // Set the brightness to default value
